        ...
        <div className='container container-fluid mt-3'>
          <div className='row'>
            <div className='col-12 col-md-8 offset-md-2'>
              ...
              <ul>
                <li><strong>360px:</strong> each content element is full-width and stacked one on top of the other, with each content element also being in a stacked view (author area above content area)</li>
                <li><strong>576px:</strong> each content element is full-width and stacked one on top of the other, with each content element having author area on the left, content area on the right (with text left-aligned)</li>
                <li><strong>768px:</strong> each content element is at most 50% of the page width, with each content element being in a stacked view</li>
                <li><strong>992px+:</strong> each content element is at most 1/3 of the page width, with each content element being in a stacked view.</li>
              </ul>
              <h4 className='mt-4'>Example Screenshots of Solution</h4>
              <p>These examples images can be found in <span className='code'>/src/assets/images/</span>.</p>
            </div>
